document.addEventListener("DOMContentLoaded", () => {
  // Smooth scroll para todos los enlaces internos con hash (#)
  ...
  const legends = {
    pele: {
      ...
      img: "web/core/templates/IMGRENE/IMG/futbolistas/pele.png",
    ...
    maradona: {
      ...
      img: "web/core/templates/IMGRENE/IMG/futbolistas/maradona.png",
    ...
    cruyff: {
      ...
      img: "web/core/templates/IMGRENE/IMG/futbolistas/cruyff.png",
    ...
    ronaldo: {
      ...
      img: "web/core/templates/IMGRENE/IMG/futbolistas/ronaldo.png",
    ...
    messi: {
      ...
      img: "web/core/templates/IMGRENE/IMG/futbolistas/messi.png",
    ...
    zidane: {
      ...
      img: "web/core/templates/IMGRENE/IMG/futbolistas/zidane.png",
    ...
    "cristiano-ronaldo": {
      ...
      img: "web/core/templates/IMGRENE/IMG/futbolistas/cristiano ronaldo.png",
    ...
    ronaldinho: {
      ...
      img: "web/core/templates/IMGRENE/IMG/futbolistas/ronaldinho.png",
  ...
  if (cards.length && detail && titleEl && subtitleEl && imgEl && bodyEl) {
    function setActiveCard(playerKey) {
      cards.forEach((c) => {
        const isActive = c.dataset.player === playerKey;
